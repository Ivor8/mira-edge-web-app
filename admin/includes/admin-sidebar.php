...
<aside class="admin-sidebar" id="adminSidebar">
    <nav class="sidebar-nav">
        <!-- Dashboard -->
        <a href="../admin/" class="nav-item <?php echo ($current_page == 'index.php' || $current_page == 'dashboard.php') ? 'active' : ''; ?>">
            <div class="nav-icon">
        ...
        <div class="nav-group">
            ...
            <div class="nav-group-content">
                <a href="/mira edge/admin/modules/projects/index.php" class="nav-subitem">All Projects</a>
                <a href="/mira edge/admin/modules/projects/add.php" class="nav-subitem">Add New</a>
                <a href="/mira edge/admin/modules/projects/categories.php" class="nav-subitem">Categories</a>
            </div>
        </div>
        ...
        <div class="nav-group">
            ...
            <div class="nav-group-content">
                <a href="/mira edge/admin/modules/services/index.php" class="nav-subitem">All Services</a>
                <a href="/mira edge/admin/modules/services/add.php" class="nav-subitem">Add Service</a>
                <a href="/mira edge/admin/modules/services/packages.php" class="nav-subitem">Packages</a>
                <a href="/mira edge/admin/modules/services/orders.php" class="nav-subitem">Orders</a>
                <a href="/mira edge/admin/modules/services/categories.php" class="nav-subitem">Categories</a>
            </div>
        </div>
        ...
        <div class="nav-group">
            ...
            <div class="nav-group-content">
                <a href="/mira edge/admin/modules/blog/index.php" class="nav-subitem">All Posts</a>
                <a href="/mira edge/admin/modules/blog/add.php" class="nav-subitem">Add New</a>
                <a href="/mira edge/admin/modules/blog/categories.php" class="nav-subitem">Categories</a>
                <a href="/mira edge/admin/modules/blog/tags.php" class="nav-subitem">Tags</a>
                <a href="/mira edge/admin/modules/blog/comments.php" class="nav-subitem">Comments</a>
            </div>
        </div>
        ...
        <div class="nav-group">
            ...
            <div class="nav-group-content">
                <a href="/mira edge/admin/modules/team/index.php" class="nav-subitem">All Members</a>
                <a href="/mira edge/admin/modules/team/add.php" class="nav-subitem">Add Member</a>
                <a href="/mira edge/admin/modules/team/teams.php" class="nav-subitem">Teams</a>
                <a href="/mira edge/admin/modules/team/roles.php" class="nav-subitem">Roles</a>
            </div>
        </div>
        ...
        <!-- Analytics -->
        <a href="/admin/modules/analytics/index.php" class="nav-item">
            <div class="nav-icon">
        ...
        <!-- Messages -->
        <a href="/admin/modules/messages/index.php" class="nav-item">
            <div class="nav-icon">
        ...
        <!-- Back to Site -->
        <a href="/" class="nav-item nav-back-to-site" target="_blank">
            <div class="nav-icon">
